...
<head>
	...
	<title><?php echo $judul_web; ?> | PPDB Online | MA AL-Hasaniyah</title>
...
<body class="navbar-bottom <?php if ($menu == 'panel_siswa' and $sub_menu == 'biodata') {
	...
	<div class="navbar navbar-inverse">
		<div class="navbar-header">
			<a class="navbar-brand" href="panel_siswa/">PPDB <label class="label label-success">Online | MA AL-Hasaniyah</label> </a>
