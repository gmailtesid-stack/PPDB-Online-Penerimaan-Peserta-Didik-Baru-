...
class Siswa extends CI_Controller {
  ...
  public function export(){
    ...
    $excel->setActiveSheetIndex(0)->setCellValue('H3', "STATUS DALAM KELUARGA");
    $excel->setActiveSheetIndex(0)->setCellValue('I3', "ANAK KE");
    $excel->setActiveSheetIndex(0)->setCellValue('J3', "JML SAUDARA");
    $excel->setActiveSheetIndex(0)->setCellValue('K3', "HOBI");
    $excel->setActiveSheetIndex(0)->setCellValue('L3', "CITA-CITA");
    $excel->setActiveSheetIndex(0)->setCellValue('M3', "PAUD");
    $excel->setActiveSheetIndex(0)->setCellValue('N3', "TK");
    $excel->setActiveSheetIndex(0)->setCellValue('O3', "NO HP");
    $excel->setActiveSheetIndex(0)->setCellValue('P3', "JENIS TEMPAT TINGGAL");
    $excel->setActiveSheetIndex(0)->setCellValue('Q3', "ALAMAT");
    $excel->setActiveSheetIndex(0)->setCellValue('R3', "DESA");
    $excel->setActiveSheetIndex(0)->setCellValue('S3', "KECAMATAN");
    $excel->setActiveSheetIndex(0)->setCellValue('T3', "KABUPATEN");
    $excel->setActiveSheetIndex(0)->setCellValue('U3', "PROVINSI");
    $excel->setActiveSheetIndex(0)->setCellValue('V3', "KODE POS");
    $excel->setActiveSheetIndex(0)->setCellValue('W3', "JARAK KE SEKOLAH");
    $excel->setActiveSheetIndex(0)->setCellValue('X3', "TRANSPORTASI");
    $excel->setActiveSheetIndex(0)->setCellValue('Y3', "NO. KK");
    $excel->setActiveSheetIndex(0)->setCellValue('Z3', "KEPALA KELUARGA");
    $excel->setActiveSheetIndex(0)->setCellValue('AA3', "NAMA AYAH");
    $excel->setActiveSheetIndex(0)->setCellValue('AB3', "TH LAHIR AYAH");
    $excel->setActiveSheetIndex(0)->setCellValue('AC3', "STATUS AYAH");
    $excel->setActiveSheetIndex(0)->setCellValue('AD3', "NIK AYAH");
    $excel->setActiveSheetIndex(0)->setCellValue('AE3', "PENDIDIKAN AYAH");
    $excel->setActiveSheetIndex(0)->setCellValue('AF3', "PEKERJAAN AYAH");
    $excel->setActiveSheetIndex(0)->setCellValue('AG3', "NAMA IBU");
    $excel->setActiveSheetIndex(0)->setCellValue('AH3', "TH LAHIR IBU");
    $excel->setActiveSheetIndex(0)->setCellValue('AI3', "STATUS IBU");
    $excel->setActiveSheetIndex(0)->setCellValue('AJ3', "NIK IBU");
    $excel->setActiveSheetIndex(0)->setCellValue('AK3', "PENDIDIKAN IBU");
    $excel->setActiveSheetIndex(0)->setCellValue('AL3', "PEKERJAAN IBU");
    $excel->setActiveSheetIndex(0)->setCellValue('AM3', "NAMA WALI");
    $excel->setActiveSheetIndex(0)->setCellValue('AN3', "TH LAHIR WALI");
    $excel->setActiveSheetIndex(0)->setCellValue('AO3', "NIK WALI");
    $excel->setActiveSheetIndex(0)->setCellValue('AP3', "PENDIDIKAN WALI");
    $excel->setActiveSheetIndex(0)->setCellValue('AQ3', "PEKERJAAN WALI");
    $excel->setActiveSheetIndex(0)->setCellValue('AR3', "PENGHASILAN AYAH");
    $excel->setActiveSheetIndex(0)->setCellValue('AS3', "PENGHASILAN IBU");
    $excel->setActiveSheetIndex(0)->setCellValue('AT3', "PENGHASILAN WALI");
    $excel->setActiveSheetIndex(0)->setCellValue('AU3', "NO KKS");
    $excel->setActiveSheetIndex(0)->setCellValue('AV3', "NO PKH");
    $excel->setActiveSheetIndex(0)->setCellValue('AW3', "NO KIP");
    $excel->setActiveSheetIndex(0)->setCellValue('AX3', "NO HP ORTU");
    $excel->setActiveSheetIndex(0)->setCellValue('AY3', "NAMA SEKOLAH");
    $excel->setActiveSheetIndex(0)->setCellValue('AZ3', "JENJANG SEKOLAH");
    $excel->setActiveSheetIndex(0)->setCellValue('BA3', "STATUS SEKOLAH");
    $excel->setActiveSheetIndex(0)->setCellValue('BB3', "NPSN SEKOLAH");
    $excel->setActiveSheetIndex(0)->setCellValue('BC3', "LOKASI SEKOLAH");
    $excel->setActiveSheetIndex(0)->setCellValue('BD3', "STATUS PENERIMAAN");
    $excel->setActiveSheetIndex(0)->setCellValue('BE3', "JURUSAN");
    ...
    foreach($siswa as $data){ // Lakukan looping pada variabel siswa
      ...
      $excel->setActiveSheetIndex(0)->setCellValue('H'.$numrow, $data->status_keluarga);
      $excel->setActiveSheetIndex(0)->setCellValue('I'.$numrow, $data->anak_ke);
      $excel->setActiveSheetIndex(0)->setCellValue('J'.$numrow, $data->jml_saudara);
      $excel->setActiveSheetIndex(0)->setCellValue('K'.$numrow, $data->hobi);
      $excel->setActiveSheetIndex(0)->setCellValue('L'.$numrow, $data->cita);
      $excel->setActiveSheetIndex(0)->setCellValue('M'.$numrow, $data->paud);
      $excel->setActiveSheetIndex(0)->setCellValue('N'.$numrow, $data->tk);
      $excel->setActiveSheetIndex(0)->setCellValueExplicit('O'.$numrow, $data->no_hp_siswa, PHPExcel_Cell_DataType::TYPE_STRING);
      $excel->setActiveSheetIndex(0)->setCellValue('P'.$numrow, $data->jenis_tinggal);
      $excel->setActiveSheetIndex(0)->setCellValue('Q'.$numrow, $data->alamat_siswa);
      $excel->setActiveSheetIndex(0)->setCellValue('R'.$numrow, $data->desa);
      $excel->setActiveSheetIndex(0)->setCellValue('S'.$numrow, $data->kec);
      $excel->setActiveSheetIndex(0)->setCellValue('T'.$numrow, $data->kab);
      $excel->setActiveSheetIndex(0)->setCellValue('U'.$numrow, $data->prov);
      $excel->setActiveSheetIndex(0)->setCellValue('V'.$numrow, $data->kode_pos);
      $excel->setActiveSheetIndex(0)->setCellValue('W'.$numrow, $data->jarak);
      $excel->setActiveSheetIndex(0)->setCellValue('X'.$numrow, $data->trans);
      $excel->setActiveSheetIndex(0)->setCellValueExplicit('Y'.$numrow, $data->no_kk, PHPExcel_Cell_DataType::TYPE_STRING);
      $excel->setActiveSheetIndex(0)->setCellValue('Z'.$numrow, $data->kepala_keluarga);
      $excel->setActiveSheetIndex(0)->setCellValue('AA'.$numrow, $data->nama_ayah);
      $excel->setActiveSheetIndex(0)->setCellValue('AB'.$numrow, $data->th_lahir_ayah);
      $excel->setActiveSheetIndex(0)->setCellValue('AC'.$numrow, $data->status_ayah);
      $excel->setActiveSheetIndex(0)->setCellValueExplicit('AD'.$numrow, $data->nik_ayah, PHPExcel_Cell_DataType::TYPE_STRING);
      $excel->setActiveSheetIndex(0)->setCellValue('AE'.$numrow, $data->pdd_ayah);
      $excel->setActiveSheetIndex(0)->setCellValue('AF'.$numrow, $data->pekerjaan_ayah);
      $excel->setActiveSheetIndex(0)->setCellValue('AG'.$numrow, $data->nama_ibu);
      $excel->setActiveSheetIndex(0)->setCellValue('AH'.$numrow, $data->th_lahir_ibu);
      $excel->setActiveSheetIndex(0)->setCellValue('AI'.$numrow, $data->status_ibu);
      $excel->setActiveSheetIndex(0)->setCellValueExplicit('AJ'.$numrow, $data->nik_ibu, PHPExcel_Cell_DataType::TYPE_STRING);
      $excel->setActiveSheetIndex(0)->setCellValue('AK'.$numrow, $data->pdd_ibu);
      $excel->setActiveSheetIndex(0)->setCellValue('AL'.$numrow, $data->pekerjaan_ibu);
      $excel->setActiveSheetIndex(0)->setCellValue('AM'.$numrow, $data->nama_wali);
      $excel->setActiveSheetIndex(0)->setCellValue('AN'.$numrow, $data->th_lahir_wali);
      $excel->setActiveSheetIndex(0)->setCellValueExplicit('AO'.$numrow, $data->nik_wali, PHPExcel_Cell_DataType::TYPE_STRING);
      $excel->setActiveSheetIndex(0)->setCellValue('AP'.$numrow, $data->pdd_wali);
      $excel->setActiveSheetIndex(0)->setCellValue('AQ'.$numrow, $data->pekerjaan_wali);
      $excel->setActiveSheetIndex(0)->setCellValue('AR'.$numrow, $data->penghasilan_ayah);
      $excel->setActiveSheetIndex(0)->setCellValue('AS'.$numrow, $data->penghasilan_ibu);
      $excel->setActiveSheetIndex(0)->setCellValue('AT'.$numrow, $data->penghasilan_wali);
      $excel->setActiveSheetIndex(0)->setCellValueExplicit('AU'.$numrow, $data->no_kks, PHPExcel_Cell_DataType::TYPE_STRING);
      $excel->setActiveSheetIndex(0)->setCellValueExplicit('AV'.$numrow, $data->no_pkh, PHPExcel_Cell_DataType::TYPE_STRING);
      $excel->setActiveSheetIndex(0)->setCellValueExplicit('AW'.$numrow, $data->no_kip, PHPExcel_Cell_DataType::TYPE_STRING);
      $excel->setActiveSheetIndex(0)->setCellValueExplicit('AX'.$numrow, $data->no_hp_ortu, PHPExcel_Cell_DataType::TYPE_STRING);
      $excel->setActiveSheetIndex(0)->setCellValue('AY'.$numrow, $data->nama_sekolah);
      $excel->setActiveSheetIndex(0)->setCellValue('AZ'.$numrow, $data->jenjang_sekolah);
      $excel->setActiveSheetIndex(0)->setCellValue('BA'.$numrow, $data->status_sekolah);
      $excel->setActiveSheetIndex(0)->setCellValue('BB'.$numrow, $data->npsn_sekolah);
      $excel->setActiveSheetIndex(0)->setCellValue('BC'.$numrow, $data->lokasi_sekolah);
      $excel->setActiveSheetIndex(0)->setCellValue('BD'.$numrow, $data->status_pendaftaran);
      $excel->setActiveSheetIndex(0)->setCellValue('BE'.$numrow, $data->komp_ahli);
